...
//        VerificarAtrasos();
        ...
        linearLayoutConfig.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intentConfig = new Intent(activity_main_test.this, activity_config.class);
        ...
        linearLayoutLogout.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Toast.makeText(activity_main_test.this, "Saindo...", Toast.LENGTH_SHORT).show();
                finish();
            }
        });
        ...
        linearLayoutAgenda.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent2 = new Intent(activity_main_test.this, activity_agenda.class);
        ...
        linearLayoutCalendar.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent2 = new Intent(activity_main_test.this, activity_calendar.class);
                startActivity(intent2);
                overridePendingTransition(R.anim.slide_in, R.anim.slide_out);
            }
        });
...
//        VerificarAtrasos();
    ...
    public void dialogFingerprint() {
        ...
        if(!sharedPrefs2.getBoolean("PrimeiroAcessoFingerPrint", false) && sharedPrefs3.getBoolean("SalvarSenha", false)){
            ...
            Dialog dialog = new Dialog(activity_main_test.this, R.style.DialogAboveKeyboard);
