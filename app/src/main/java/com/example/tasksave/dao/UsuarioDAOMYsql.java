...
public class UsuarioDAOMYsql {
    ...
    public String getTextoVersaoAPP() {
        ...
        try {
            ...
            String query = "SELECT texto_versao FROM versaoapp WHERE id = 3";
            PreparedStatement statement = conn.prepareStatement(query);
            ResultSet resultSet = statement.executeQuery();
    ...
    public String getTexto1APP() {
        ...
        try {
            ...
            String query = "SELECT texto_1 FROM versaoapp WHERE id = 3";
            PreparedStatement statement = conn.prepareStatement(query);
            ResultSet resultSet = statement.executeQuery();
    ...
    public String getTexto2APP() {
        ...
        try {
            ...
            String query = "SELECT texto_2 FROM versaoapp WHERE id = 3";
            PreparedStatement statement = conn.prepareStatement(query);
            ResultSet resultSet = statement.executeQuery();
    ...
    public String getTexto3APP() {
        ...
        try {
            ...
            String query = "SELECT texto_3 FROM versaoapp WHERE id = 3";
            PreparedStatement statement = conn.prepareStatement(query);
            ResultSet resultSet = statement.executeQuery();
